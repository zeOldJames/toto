 ...
 * the License.
 */
package com.github.framework3eclipse.dto;
...
public class MethodInsertionPoint {
	...
	public MethodInsertionPoint(CompilationUnitEditor editor) throws JavaModelException {
		...
		members = insertionType.getChildren();
	...
	private int getElementAfterCursorPosition(IJavaElement members[], CompilationUnitEditor editor)
	...
	public IJavaElement[] getMembers() {
		return members;
	}
